...
$indexShardScriptPath = Join-Path -Path $repoRoot -ChildPath 'src\QuickSearch.IndexShard.ps1'
...
$quickSearchSource = Join-QuickSearchPowerShellSource -Path @($indexStatusScriptPath, $indexPolicyScriptPath, $indexResumeScriptPath, $indexShardScriptPath, $queryScriptPath, $indexScriptPath, $searchScriptPath, $asyncScriptPath, $previewScriptPath, $profileScriptPath, $supportScriptPath, $mainScriptPath)
